						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">{{$v_category->catagery_discription}}</td>
								...
								<td class="center">
								@if($v_category->status==1)
									<a class="btn btn-success" href="{{URL::to('/unactive_category/'.$v_category->category_id)}}">
